  ...
  return (
    <div className="container">
      ...
      <div className="container bg-teal-light p-10 text-center my-3 rounded-md flex items-center lg:h-[550px]">
        <div>
          <h2 className="text-base-200 text-2xl md:text-3xl lg:text-4xl font-semibold my-3">About Me</h2>
          ...
          <ul className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 text-base-100 w-3/4 mx-auto my-10">
      ...
      <div className="container flex items-center lg:h-[650px]">
        <div className="p-10">
          <h2 className="text-2xl md:text-3xl lg:text-4xl text-base-200 font-semibold text-center mb-3">What I Do</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
            <div className="card">
              ...
              <h3 className="text-xl md:text-2xl lg:text-3xl text-base-200 font-semibold">Frontend Development</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl md:text-2xl lg:text-3xl text-base-200 font-semibold">Backend Development</h3>
            ...
            <div className="card">
              ...
              <h3 className="text-xl md:text-2xl lg:text-3xl text-base-200 font-semibold">Machine Learning</h3>
