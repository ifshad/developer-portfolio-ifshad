...
const projects = [
  {
    ...
    imageUrl: "https://i.ibb.co/PgtBpm8/tech-dynasty-ss.png",
    description:
  ...
  },
  {
    ...
    imageUrl: "https://i.ibb.co/869JYBs/tensor-times-ss.png",
    description:
  ...
  },
  {
    ...
    imageUrl: "https://i.ibb.co/PG91mT2/portfolio-ss.png",
    description:
...
export default function PortfolioPage() {
  return (
    <div id="projects" className="container md:py-16 relative">
      ...
      <div className="absolute w-[450px] h-[450px] rounded-full bg-indigo-500/30 bottom-0 right-0  blur-3xl -z-30"></div>
      {/* Description */}
        ...
        {projects.map((project, i) => (
          ...
          >
            ...
            <div className="row-span-3">
              {/* <Image src={project.imageUrl} alt={project.title} width={60} height={30}/> */}
