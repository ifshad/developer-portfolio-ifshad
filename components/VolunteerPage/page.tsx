  ...
  return (
    <div className="container flex flex-col gap-2 m-4">
      ...
      <motion.div
        ...
        ref={scrollRef}
        className="card md:ml-9 grid-cols-12"
      >
        <figure className="col-span-1 text-3xl"></figure>
        <p className="col-span-1">2019</p>
        <h2 className="font-semibold text-lg col-span-3">Robotronics 1.0</h2>
        <p className="text-base font-medium col-span-6">
