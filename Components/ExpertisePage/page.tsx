            ...
            {languages.map((language, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{language.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {devFrameworks.map((framework, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{framework.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {mlUtility.map((utility, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{utility.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {databases.map((db, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{db.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {cloudServices.map((cs, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{cs.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {graphics.map((graphic, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{graphic.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
            ...
            {others.map((other, i) => (
              <TooltipProvider key={i}>
                <Tooltip>
                  ...
                  <TooltipContent>{other.langName}</TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ))}
          </div>
